...
# cluster name = namespace-stage-name
variable "namespace" {
  type        = "string"
  description = "namespace to prefix your cluster, e.g. 'lastname'. Cluster will be named: <namespace>-demo-app"
}
...
# as reference keptn sockshop uses: t3.2xlarge
